...
class CropFeatureTest(unittest.TestCase):
    ...
    def test_filter_uploads(self):
        ...
        # taps on text feature
        tapTextFeature = EditorPage(driver)
        tapTextFeature.tapTextFeature()

        # taps on League Gothic font
        tapsOnFont = EditorPage(driver)
        tapsOnFont.tapLeagueGothic()

        # taps the done Button
        sendText = EditorPage(driver)
        sendText.typeInTextBox()
