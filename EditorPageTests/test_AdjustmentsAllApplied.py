...
class AdjustmentsFeatureTest(unittest.TestCase):
    ...
    def test_filter_uploads(self):
        ...
        # taps exposure adjustment
        tapExposure = EditorPage(driver)
        tapExposure.tapExposure()
        ...
        # taps contrast adjustment
        tapAdjustment = EditorPage(driver)
        tapAdjustment.tapContrast()
